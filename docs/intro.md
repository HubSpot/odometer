...
**The simplest possible usage is just including [the javascript](https://raw.github.com/HubSpot/odometer/v0.4.1/odometer.min.js) and a [theme css](http://github.hubspot.com/odometer/api/themes/)
